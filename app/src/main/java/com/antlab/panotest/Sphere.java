...
class Sphere {
    ...
    void uploadVerticesBuffer(int positionHandle) {
        ...
        Shade.checkGlError("glVertexAttribPointer maPosition");
    ...
    void uploadTexCoordinateBuffer(int textureCoordinateHandle) {
        ...
        Shade.checkGlError("glVertexAttribPointer maTextureHandle");
        GLES20.glEnableVertexAttribArray(textureCoordinateHandle);
        Shade.checkGlError("glEnableVertexAttribArray maTextureHandle");
    }
    ...
    private FloatBuffer getTexCoordinateBuffer() {
